...
- Confirm with the admin before writing. On approval, `Write` to `knowledge-bases/<filename>.md` (unless the admin asked for a different KB collection — then `knowledge-bases/<that>/<filename>.md`).
...
Captured the answer as `knowledge-bases/how-to-reset-vpn-password.md`.
```
