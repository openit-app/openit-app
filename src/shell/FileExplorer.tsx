...
export function FileExplorer({
  ...
  //   - `.openit/` directory and everything under it (engine state,
  //     manifests, traces — useful for debugging sync, so reveal under
  //     the same toggle as the rest of the scaffolding)
  ...
  const visible = useMemo(() => {
    ...
    return nodes.filter((n) => {
      ...
      // any other database. Click-to-open routing in Viewer still maps
      // a ticket card to its conversation thread.
